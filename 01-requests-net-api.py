...
# Debug pretty print
# pp.pprint(user_list)
# Create an empty list, for the username(sP on the device to be entered into
...
# If/else list comparision to check that allowed usernames exactly match what is on the device.
